...
2. **Servidor FastMCP.** Monte as ferramentas. Configure o transporte StreamableHTTP. Adicione um middleware para introspection de token OAuth e aplicação de escopos.
