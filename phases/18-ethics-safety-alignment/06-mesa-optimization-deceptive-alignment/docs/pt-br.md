...
**Pré-requisitos:** Fase 10 · 06 (SFT), Fase 09 (fundamentos de RL)
**Tempo:** ~75 minutos
...
| Hacking de gradiente | "moldando o gradiente" | Especificaçãoulativo: mesa-otimizador influencia suas próprias atualizações de gradiente para preservar seu objetivo-mesa |
