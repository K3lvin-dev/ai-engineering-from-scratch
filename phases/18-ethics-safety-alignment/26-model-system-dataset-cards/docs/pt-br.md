...
`code/main.py` gera um model card mínimo, um datasheet e um system card para um implantação fictício. Cada um segue a estrutura canônica de seções. Você pode especificar o formato e comparar os três escopos.
