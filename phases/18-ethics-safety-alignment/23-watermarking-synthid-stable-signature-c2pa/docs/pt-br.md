...
- **Especificaçãoífico do modelo.** SynthID marca gerações de modelos habilitados com SynthID. Uma geração de modelo sem SynthID não é marcada, então "sem sinal SynthID" não é prova de autenticidade.
