...
Primeiro experimento específico de LLM: injete 429 de um provedor por 5 minutos. Observe o fallback. A maioria dos times descobre que o reserva não foi totalmente testado.
