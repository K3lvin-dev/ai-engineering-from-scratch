...
2. **Médio.** Construa o espectrograma log-mel completo usando `numpy.fft`. Verifique que 80 bandas mel combinam com `librosa.feature.melespectrogram(n_mels=80)` dentro de erro numérico.
