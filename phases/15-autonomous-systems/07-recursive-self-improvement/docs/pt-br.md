...
`outputs/skill-rsi-cycle-pause-especificação.md` especificaçãoifica as condições sob as quais um pipeline RSI deve pausar e esperar revisão humana antes do próximo ciclo.
