...
- [MCP — Basic transports especificação 2025-11-25](https://modelcontextprotocol.io/specification/2025-11-25/basic/transports) — referência canônica pra stdio e Streamable HTTP
- [MCP — Basic transports especificação 2025-03-26](https://modelcontextprotocol.io/specification/2025-03-26/basic/transports) — a revisão que introduziu Streamable HTTP
