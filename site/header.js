...
(function () {
  ...
  var TRANSLATIONS = {
    ...
    'pt-br': {
      ...
      'Run the Code': 'Rodar o codigo',
      'Test Your Understanding': 'Teste seu entendimento',
      'Learning Path': 'Trilha de aprendizado',
      'Continue Learning': 'Continuar aprendendo',
      // Panel subtitles
      'Prompts, skills, and artifacts you can use right now': 'Prompts, skills e artefatos que voce pode usar agora',
      'Executable files from this lesson': 'Arquivos executaveis desta aula',
      'Did you get it?': 'Voce entendeu?',
      // Loading states
      'Loading lesson...': 'Carregando aula...',
      'Loading outputs...': 'Carregando artefatos...',
      'Loading code files...': 'Carregando arquivos de codigo...',
      'Loading description...': 'Carregando descricao...',
      ...
      'Perfect score!': 'Pontuacao perfeita!',
      'Great work!': 'Otimo trabalho!',
      ...
      // Learning path
      'You have completed': 'Voce completou',
      'lessons in this phase': 'aulas nesta fase',
      'Ready for Phase': 'Pronto para a Fase',
      // Continue panel
      'You finished this phase!': 'Voce finalizou esta fase!',
      'Browse all Phase': 'Ver todas as aulas da Fase',
      'lessons': 'aulas',
      'Full course catalog': 'Catalogo completo do curso',
      // Quiz sections
      'Pre-Lesson Check': 'Verificacao Pre-Aula',
      'Mid-Lesson Check': 'Verificacao intermediaria',
      'Post-Lesson Quiz': 'Quiz Pos-Aula',
      // Deep quiz prompt
      'Want a deeper quiz? Run': 'Quer um quiz mais profundo? Execute',
      'in Claude, Cursor, Codex, OpenClaw, Hermes, or any agent with the curriculum skills installed': 'no Claude, Cursor, Codex, OpenClaw, Hermes ou qualquer agente com as skills do curriculo instaladas',
      'Run': 'Execute',
      'in Claude, Cursor, Codex, OpenClaw, Hermes, or any agent with the curriculum skills installed for a personalized learning path': 'no Claude, Cursor, Codex, OpenClaw, Hermes ou qualquer agente com as skills do curriculo instaladas para uma trilha personalizada',
      // Other page strings
      ...
      'Final destination. End of the curriculum.': 'Destino final. Fim do curriculo.',
      'Read': 'Ler',
      ...
      'Home': 'Inicio',
      'Lesson Catalog - AI Engineering from Scratch': 'Catalogo de Aulas - AI Engineering from Scratch',
      'AI Glossary - AI Engineering from Scratch': 'Glossario de IA - AI Engineering from Scratch',
      ...
      'Add a ?path= parameter to the URL.': 'Adicione um parametro ?path= a URL.',
      'Render error': 'Erro de renderizacao',
      ...
      'Lesson not found': 'Aula nao encontrada',
      'Could not fetch the lesson at': 'Nao foi possivel buscar a aula em',
      'It may not have been written yet.': 'Pode ser que ainda nao tenha sido escrita.',
      ...
      'Quiz': 'Quiz',
      'Diagram could not be rendered.': 'O diagrama nao pôde ser renderizado.',
      // Output badges
      'Prompt': 'Prompt',
      'Skill': 'Skill',
      'Output': 'Saida',
